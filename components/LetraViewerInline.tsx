...
export default function LetraViewerInline({ musica, selectedIndex: initialIndex }: LetraViewerInlineProps) {
  ...
  const letra = musica.letras[selectedIndex]

  if (!letra) {
    return <div className="text-center text-gray-500 dark:text-gray-400">Letra não encontrada.</div>
  }
    ...
    <div className="space-y-6">
      {musica.letras.length > 1 && (
        <div className="mb-4">
          ...
          >
            {musica.letras.map((l: Letra, index: number) => (
